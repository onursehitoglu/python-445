...
capmap = qt.QuadTree(-180,-180, 180,180)

for lat,lon,name in capitals:
	capmap.insert(lat, lon, name)

print("ALL","-" * 50)
for loc in capmap.query(0,0,50,50):
	print(loc.lat, loc.lon, loc.title)
print("MID","-" * 50)
for loc in capmap.query(20,20,40,40):
	print(loc.lat, loc.lon, loc.title)
